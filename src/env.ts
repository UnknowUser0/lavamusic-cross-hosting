...
const envSchema = z.object({
	...
	HOST_SERVER:z.string().default('localhost'),
	PORT_BOT:z.string().default('4444'),
	AUTHTOKEN:z.string().default('xxx-auth-token'),
	TOTALSHARDS:z.string().default('1'),
	TOTALMACHINES:z.string().default('1'),
	SHARDPERCLUSTER:z.string().default('1'),
